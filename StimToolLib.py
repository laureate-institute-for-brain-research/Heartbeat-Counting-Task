...
import csv, os, ctypes, ast, numpy, sys, logging
...
def error_popup(msg):
    ...
    error_msg.show()
    raise QuitException()
def general_setup(g, winType = 'pyglet'):
    ...
    g.win = visual.Window(fullscr=False, screen=g.session_params['screen_number'],color=(-1,-1,-1), waitBlanking=True, colorSpace='rgb',winType=winType, allowGUI=False, size=(g.session_params['screen_x'], g.session_params['screen_y']), monitor=thisMon) 
